...
function BrandLogo({ brand }: { brand: string }) {
  ...
  if (brand === "Samsung") {
    return <span className="text-xs font-black tracking-[0.18em] text-[#1428A0]">SAMSUNG</span>;
  }
  if (brand === "Huawei") {
    return (
      <svg viewBox="0 0 64 64" className="h-8 w-8" aria-hidden="true">
        <path fill="#CF0A2C" d="M32 4c-1.5 4-2 8-1 12 1 3.5 3.5 6 1 10-1.5 2.5-3 3-3 6 0-3-1.5-3.5-3-6-2.5-4 0-6.5 1-10 1-4 .5-8-1-12z"/>
        <path fill="#CF0A2C" opacity="0.85" d="M60 32c-4-1.5-8-2-12-1-3.5 1-6 3.5-10 1-2.5-1.5-3-3-6-3 3 0 3.5-1.5 6-3 4-2.5 6.5 0 10 1 4 1 8 .5 12-1z"/>
        <path fill="#CF0A2C" opacity="0.65" d="M32 60c1.5-4 2-8 1-12-1-3.5-3.5-6-1-10 1.5-2.5 3-3 3-6 0 3 1.5 3.5 3 6 2.5 4 0 6.5-1 10-1 4-.5 8 1 12z"/>
        <path fill="#CF0A2C" opacity="0.45" d="M4 32c4 1.5 8 2 12 1 3.5-1 6-3.5 10-1 2.5 1.5 3 3 6 3-3 0-3.5 1.5-6 3-4 2.5-6.5 0-10-1-4-1-8-.5-12 1z"/>
      </svg>
    );
  }
  ...
  if (brand === "Xiaomi") {
    return (
      <div className="flex flex-col items-center gap-1.5">
        ...
        <span className="text-xs font-bold text-[#FF6900]">Xiaomi</span>
      </div>
    );
  }
  if (brand === "Laptop / Mac") {
    return (
      <div className="flex flex-col items-center gap-1.5">
        <LaptopIcon className="h-8 w-8 text-[#64B5F6]" />
        <span className="text-[10px] font-bold text-neutral-400">Laptop / Mac</span>
      </div>
    );
  }
              ...
              {BRANDS.map((b) => (
                ...
                >
                  ...
                  {b !== "Xiaomi" && b !== "Laptop / Mac" && (
                    <span className="text-[10px] font-semibold leading-tight text-center text-neutral-300">
                      {b}
                    </span>
                  )}
                </motion.button>
